...
export default function VotePage() {
  ...
  useEffect(() => {
    async function loadStudy() {
      try {
        ...
        // Load the most recent active study
        ...
        // Load captions via study_caption_mappings
        ...
        // Load caption text + associated image
  ...
  const submitVote = useCallback(
    async (value: VoteValue) => {
      ...
      if (voteErr) {
        console.error("Vote insert error:", voteErr.message);
      }
